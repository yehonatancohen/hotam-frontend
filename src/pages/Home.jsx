    ...
    <div dir="rtl" className="transition-colors duration-300" style={{ background: t.bg, color: t.text }}>
      ...
      <section className="flex flex-col lg:flex-row min-h-[90vh] items-stretch">
        ...
        <div className="flex-1 lg:flex-[1.25] flex flex-col justify-center px-6 md:px-16 py-20 lg:pt-[120px] lg:pr-[15%] lg:pb-[80px] lg:pl-[48px]" style={{ background: t.bg }}>
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <Link 
                to="/products"
                className="px-8 py-4 rounded-none font-headline font-bold text-base text-center transition-all duration-200"
              ...
              <a 
                ...
                className="px-6 py-4 rounded-none font-headline font-medium text-sm text-center border transition-all duration-200 flex items-center gap-2"
        ...
        <div className="flex-1 lg:flex-[0.75] relative overflow-hidden min-h-[350px] lg:min-h-0">
          ...
          />
          <div 
            className="absolute bottom-6 right-6 p-4 rounded-none shadow-lg border text-right"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map(p => {
              ...
              return (
                <div 
                  key={p.id}
                  className="rounded-none border p-6 flex flex-col transition-all duration-300 group"
                  style={{
                    background: t.bgCard,
                ...
                >
                  <div className="w-full aspect-[4/3] rounded-none overflow-hidden bg-white/50 mb-6 relative border" style={{ borderColor: t.border }}>
                    <img 
                      src={src} 
                      alt={p.name_he} 
                  ...
                  <div className="flex items-center justify-between mt-auto border-t pt-4" style={{ borderColor: t.border }}>
                    ...
                    <Link 
                      to={`/products/${p.id}`}
                      className="px-5 py-2.5 rounded-none text-sm font-bold transition-all duration-200"
                      style={{ background: t.accent, color: t.accentText }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
            ...
            {STEPS.map(s => (
              <div key={s.n} className="text-center relative z-10">
                <div 
                  className="w-16 h-16 rounded-none flex items-center justify-center font-headline font-bold text-lg mb-6 mx-auto shadow-sm border-2"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {REVIEWS.map((r, idx) => (
              <div 
                key={idx} 
                className="border rounded-none p-8 transition-colors duration-300"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-none font-headline font-bold text-sm transition-all duration-200"
              style={{ background: t.accent, color: t.accentText }}
              onMouseEnter={e => e.currentTarget.style.background = t.accentHover}
              onMouseLeave={e => e.currentTarget.style.background = t.accent}
            >
          ...
          <div className="rounded-none overflow-hidden aspect-square lg:aspect-auto lg:h-[450px] border" style={{ borderColor: t.border }}>
            <img 
      ...
      <section id="contact" className="py-24 px-6 md:px-16 transition-colors duration-300" style={{ background: t.bg }}>
        <div className="max-w-3xl mx-auto">
          ...
          {contactSent ? (
            <div className="text-center py-12 border p-8 bg-white/40" style={{ borderColor: t.border }}>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-none font-headline font-bold text-sm text-white"
            ...
            <form onSubmit={handleContactSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-2">
                <button 
                  type="submit"
                  className="flex-1 py-4 rounded-none font-headline font-bold text-base border-0 cursor-pointer transition-all duration-200"
                  style={{ background: t.accent, color: t.accentText }}
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-4 rounded-none font-headline font-medium text-sm text-center border transition-all duration-200 flex items-center justify-center gap-2"
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 z-40 w-14 h-14 rounded-none flex items-center justify-center shadow-lg transition-all duration-200 border-2"
        style={{ background: '#25D366', color: '#fff', borderColor: '#25D366', boxShadow: '0 4px 18px rgba(37,211,102,0.3)' }}
